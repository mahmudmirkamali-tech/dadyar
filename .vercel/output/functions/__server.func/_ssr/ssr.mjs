...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C94a0IbD.mjs");
...
var manifest = {
	"1b2161ab14979aa152ad18e900d119f3f6e758eae6c730d93b8f206cee0ad40d": {
		functionName: "analyzeMatter_createServerFn_handler",
		importer: () => import("./legal-ai-DHbwA3SQ.mjs")
	},
	"61ba1250a496ebd3a1443c7e66563a6e16f0742d4bdc133f861b793ac283b83d": {
		functionName: "consultChat_createServerFn_handler",
		importer: () => import("./legal-ai-DHbwA3SQ.mjs")
	},
	"78b18d8949e4fc93b1dc3951f8c9f60881289c9c912dc26c7fe30f766c3b72c6": {
		functionName: "draftDocument_createServerFn_handler",
		importer: () => import("./legal-ai-DHbwA3SQ.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DEGNaH46.mjs").then((n) => n.t),
